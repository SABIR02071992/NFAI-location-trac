...
import 'package:m_app/src/features/punchin/view/individual_punch_in_screen.dart';
import 'package:m_app/src/features/punchin/view/individual_ship_punch_in_screen.dart';
import 'package:m_app/src/features/punchin/view/team_field_punch_in_screen.dart';
import 'package:m_app/src/features/punchin/view/team_ship_punch_in_screen.dart';
import 'package:m_app/src/features/splash/splash_screen.dart';
import 'package:m_app/src/features/teams/view/teams_screen.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: '/individual_punch_in', page: () => const IndividualPunchIn()),
